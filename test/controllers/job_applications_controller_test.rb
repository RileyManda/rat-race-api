...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference("JobApplication.count") do
      post job_applications_url, params: { job_application: { cover_letter: @job_application.cover_letter, resume: @job_application.resume, role_id: @job_application.role_id, status: @job_application.status, user_id: @job_application.user_id } }, as: :json
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { cover_letter: @job_application.cover_letter, resume: @job_application.resume, role_id: @job_application.role_id, status: @job_application.status, user_id: @job_application.user_id } }, as: :json
    assert_response :success
  end
